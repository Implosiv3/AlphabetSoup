$(document).ready(function() {
    ...
    function saberCelda(event) {
        if (sopaGenerada) {
            if (palabrasOriginales.length != palabrasDescubiertas.length) {
                ...
                if (confirm('The game finished. If you press Accept or reload the web page you will play again.'))
                    location.reload(true);
            }
        } else
            alert('The game did not start. You must add some words and press the PLAY button.');
    }
    ...
    function anadirPalabra() {
        ...
        !palabra.includes(';')) {
                ...
                alert('You must write a word with with 2 characters as minimun and 10 as maximun.\nDo not use spaces or special characters.');
        } else
            alert('The words limit is 15.');
    }
    ...
    function asignarEvento() {
        ...
        /*for (var i = 0; i < 15; i++) {
            for (var j = 0; j < 15; j++) 
                //$(obtenerCelda(i + 1, j + 1)).click(saberCelda());
                obtenerCelda(i + 1, j + 1).addEventListener("click", saberCelda);
        }*/
    }
    ...
    function marcarPalabraCorrecta(palabra) {
        ...
        setTimeout(function() {
            if (palabrasDescubiertas.length == palabrasOriginales.length) {
                if (confirm('Well done! You found all words in the alphabet soup.\nDo you want to play again?'))
                    location.reload(true);
            }
        }, 1000);
    }
